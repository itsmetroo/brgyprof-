    ...
    <div class="row text">
        ...
        <div class="column-body-left text-center " >
         ...
         <p style="  text-indent: 40px;font-size: 17px ; font-family: Arial, Helvetica, sans-serif;text-justify: inter-word;">
            This <b>CERTIFICATION</b> is being issued upon the request of DAVAO'S PNP for whatever legal purposes it may serve.</p>
            <br>
            <p style=" text-indent: 50px;font-size: 17px ; font-family: Arial, Helvetica, sans-serif; text-align: justify;text-justify: inter-word;">
                DONE AND ISSUED this <b>15<sup>th</sup></b> day of <b>MAY, 2025</b> at the Office of the Punong Barangay, Barangay Talomo, Davao City, Davao Del Sur, Philippines.</p>
                <br>
                <div class="row">
                    <br>
                    <br>
