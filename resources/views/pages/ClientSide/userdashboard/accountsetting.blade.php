            ...
            <div class="rounded shadow-lg border border-secondary p-4" style="font-size: 20px">
                ...
                <div class="form-row p-3" >
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <textarea id="resident_accountsetting_address_1" name="resident_accountsetting_address_1" placeholder="P.O. Box 1201, Davao City Central Post Office 8000 Davao City"  class="form-control " rows="2" style="resize: none;"></textarea>
                    </div>

                    <div class="col-sm-6 form-group">
                        <label for="resident_accountsetting_address_2">Address 2</label>
                        <textarea type="textbox" id="resident_accountsetting_address_2" name="resident_accountsetting_address_2" placeholder="P.O. Box 1121, Davao City Central Post Office 8000 Davao City, Davao Region"  class="form-control " rows="2" style="resize: none;"></textarea>
                    </div>
