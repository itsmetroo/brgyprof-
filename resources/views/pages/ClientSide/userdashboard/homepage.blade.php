...
<body style="margin: 0 0 169px;">
    ...
    <div class="container" style="margin-top: 20px;align-items: center;margin-bottom: 70px;">
        <div class="row" style="align-items: center;">
            ...
            <div class="col-md-6">
                <p><br>VISION<br>An empowered and healthy Dabawenyos in a globally-competitive, ecologically balanced and peaceful Daval Del Sur under a responsive and accountable governance.<br><br>MISSION<br>We shall sustain our delivery of services to the fullest of our abilities, harnessing our potentials, and building more meaningful teamwork;

We will hold and promote at all times the principles and policies of the Provincial Government; and

Cognizant of our avowed purpose, we commit ourselves to make Davao Del Sur a challenge to the adventurous, a haven for the travelers, and a real home for the Dabawenyos.<br><br></p>
            </div>
        </div>
    </div>
    <br><br>
        ...
        <div class="container text-white">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 item social"><a href="#"><i class="icon ion-social-facebook"></i></a><a href="#"><i class="icon ion-social-twitter"></i></a><a href="#"><i class="icon ion-social-snapchat"></i></a><a href="#"><i class="icon ion-social-instagram"></i></a>
                    <p class="copyright">Brgy Talomo Dist. System © 2022</p>
                </div>
            </div>
        </div>
    </footer>
