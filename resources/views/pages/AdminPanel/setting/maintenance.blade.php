                  ...
                  <form class="needs-validation" novalidate="" action="{{ route('image.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input  class="form-control" id="name" name="barangay_name" value="{{ $Barangayimage->barangay_name ?? '' }}" placeholder="Ex: Barangay Talomo">
                        <div class="invalid-feedback">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="city" name="city" value="{{ $Barangayimage->city ?? '' }}"placeholder="Ex: Davao" required="">
                        <div class="invalid-feedback">
                           Input Field Required
                        </div>
                     </div>
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="province" value="{{ $Barangayimage->province ?? '' }}" name="province" placeholder="Ex: Talomo" required="">
                        <div class="invalid-feedback">
                           Input Field Required
                        </div>
                     </div>
