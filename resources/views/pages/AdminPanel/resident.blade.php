                        ...
                        <div class="row" style="margin-left: 0px;margin-right: 0px;">
                         ...
                         <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                               <input type="text" id="birthplace" name="birthplace" placeholder="Ex: Davao City, Calinan"   required="required" class="form-control ">
                        ...
                        <div class="row" style="margin-left: 0px;margin-right: 0px;">
                         ...
                         <div class="row" style="margin-left: 0px;margin-right: 0px;">
                           <div class="col-sm-6">
                              ...
                              <input type="text" class="form-control" name="PAG_IBIG" id="PAG_IBIG" placeholder="Ex: 1234-5678-9101" maxlength="14" value="">
                              <span id="PAG_IBIG_err" class="text-danger error-text PAG_IBIG_err"></span>
                           </div>
                           <div class="col-sm-6">
                              <label>PHILHEALTH</label>
                              <input type="text" class="form-control" name="PHILHEALTH" id="PHILHEALTH" placeholder="Ex: 0028-1215160-9" maxlength="14" value="">
                           ...
                           <div class="col-sm-6">
                              <label>SSS</label>
                              <input type="text" class="form-control" name="SSS" id="SSS" placeholder="Ex: 04-0751449-0" maxlength="12" value="">
                              <span id="SSS_err" class="text-danger error-text SSS_err"></span>
                           </div>
                           <div class="col-sm-6">
                              <label>TIN</label>
                              <input type="text" class="form-control" name="TIN" id="TIN" placeholder="Ex: 123-456-789-000" maxlength="15" value="">
                         ...
                         <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                               <input type="text" id="address_1" name="address_1" placeholder="Ex: P.O. Box 1201, Davao City Central Post Office
                               8000 Davao City" required="required" class="form-control ">
                         ...
                         <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                               <input type="text" id="address_2" name="address_2" placeholder="Ex: P.O. Box 1121, Davao City Central Post Office
                               8000 Davao City, Davao Del Sur" required="required" class="form-control ">
